...
public class Angajat extends Persoana {
    ...
    public Angajat(String nume, String prenume, String varsta, String sex, String adresa, String firma, String pozitie, int salariu, String experienta) {
    ...
    public void infoAngajat(){
        ...
        System.out.println("Pozitia angajatului este: "+ pozitie);
